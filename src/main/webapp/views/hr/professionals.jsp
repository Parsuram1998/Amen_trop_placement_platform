...
<div class="main">
    ...
    <div class="header">
        ...
        <p>Browse experienced and verified candidates</p>
    </div>
    ...
    <div class="table-card">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="name">${p.user.fullName}</td>

                <td class="muted">${p.user.email}</td>

                <td>${p.user.phone}</td>

                <td>
                    <span class="exp">${p.experienceYears} yrs</span>
                </td>

                <td>${p.currentRole}</td>

                <td class="muted">${p.skillSet}</td>
